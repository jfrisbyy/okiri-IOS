...
function WordOrderExerciseInner({
  scrambledWords,
  correctAnswer,
  prompt,
  onAnswer,
  ...
  const [bankWords, setBankWords] = useState<string[]>(scrambledWords);
  ...
  }, [scrambledWords, resultFade, shakeAnim]);
    ...
    <View style={styles.container}>
      <View style={styles.headerRow}>
        <View style={styles.badge}>
          <Text style={styles.badgeText}>Word Order</Text>
        </View>
      </View>
      ...
      {showHint && (
        <View style={styles.hintBox}>
          <Text style={styles.hintText}>Starts with: {correctAnswer.split(' ')[0]}</Text>
        </View>
      )}
      ...
      >
        {placedWords.length === 0 && !result && (
          <Text style={styles.answerPlaceholder}>Tap words below to arrange them</Text>
        )}
            ...
            return (
              <Animated.View key={key} style={{ opacity: anim, transform: [{ scale: anim }] }}>
                <AnimatedPressable
                  ...
                  disabled={!!result}
                >
                  <Text style={styles.chipNumber}>{i + 1}</Text>
                  <Text style={[
                    styles.chipText,
          ...
          {result === 'correct' ? (
            <View style={styles.resultBox}>
              <View style={styles.resultIconRow}>
                ...
                <Text style={styles.resultCorrectText}>Perfect order!</Text>
              </View>
            </View>
          ) : (
            <View style={styles.resultBox}>
              <Text style={styles.resultIncorrectText}>Wrong order</Text>
              <Text style={styles.correctionLabel}>Correct order:</Text>
...
export default React.memo(WordOrderExerciseInner);
