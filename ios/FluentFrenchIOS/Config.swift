...
enum Config {
    ...
    static let EXPO_PUBLIC_SUPADATA_API_KEY = ""
    static let EXPO_PUBLIC_YOUTUBE_API_KEY = ""

    static let allValues: [String: String] = [
        "EXPO_PUBLIC_ELEVENLABS_API_KEY": EXPO_PUBLIC_ELEVENLABS_API_KEY,
        "EXPO_PUBLIC_NEWSAPI_KEY": EXPO_PUBLIC_NEWSAPI_KEY,
        ...
        "EXPO_PUBLIC_SUPADATA_API_KEY": EXPO_PUBLIC_SUPADATA_API_KEY,
